...
<li >
    <a href="/users/{{ Auth::user()->id}} "  ><i class="fa fa-user"></i><span>Become an instructor
</span></a>
</li>
...
{{--    </li>--}}
    ...
    <li class="{{ Request::is('comments*') ? 'active' : '' }}">
        <a href="{{ route('comments.index') }}"><i class="fa fa-check-circle"></i><span>Comments</span></a>
    </li>

    <li class="{{ Request::is('items*') ? 'active' : '' }}">
        <a href="{{ route('items.index') }}"><i class="fa fa-cog"></i><span>Items</span></a>
    </li>
    ...
    <li class="{{ Request::is('views*') ? 'active' : '' }}">
        <a href="{{ route('views.index') }}"><i class="fa fa-street-view"></i><span>Views</span></a>
    </li>

    <li class="{{ Request::is('roles*') ? 'active' : '' }}">
        <a href="{{ route('roles.index') }}"><i class="fa fa-rotate-left"></i><span>Roles</span></a>
    </li>
...
<li class="{{ Request::is('courseOutlines*') ? 'active' : '' }}">
    <a href="{{ route('courseOutlines.index') }}"><i class="fa fa-outdent"></i><span>Course Outlines</span></a>
</li>
